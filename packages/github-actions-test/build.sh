...
TERMUX_PKG_VERSION=2:2.11.4
TERMUX_PKG_REVISION=1
TERMUX_PKG_SRCURL=https://github.com/jgm/pandoc/releases/download/${TERMUX_PKG_VERSION:2}/pandoc-${TERMUX_PKG_VERSION:2}-linux-amd64.tar.gz
