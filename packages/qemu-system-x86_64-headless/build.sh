...
TERMUX_PKG_DEPENDS="attr, glib, libandroid-shmem, libbz2, libc++, libcap, libcurl, libgnutls, libjpeg-turbo, liblzo, libnettle, libpixman, libpng, libsasl, libssh2, libutil, ncurses, qemu-common"
...
termux_step_configure() {
	...
	./configure \
		...
		--disable-guest-agent --enable-pie --disable-sdl \
		--disable-gtk --disable-vte --enable-curses --enable-vnc \
		--enable-vnc-jpeg --enable-vnc-png --enable-vnc-sasl \
		--disable-mpath --disable-xen --enable-curl --enable-fdt \
