...
local _MAJOR_VERSION=1.13rc1
# Use the ~ deb versioning construct in the future:
TERMUX_PKG_VERSION=2:${_MAJOR_VERSION}
TERMUX_PKG_SRCURL=https://storage.googleapis.com/golang/go${_MAJOR_VERSION}.src.tar.gz
TERMUX_PKG_SHA256=dc5c1f4501daf486f69ca9a795202b289824c303291bf26c42a5b6c1770ba3a9
TERMUX_PKG_DEPENDS="clang"
TERMUX_PKG_CONFLICTS="golang"
TERMUX_PKG_REPLACES="golang"
TERMUX_PKG_PROVIDES="golang"
